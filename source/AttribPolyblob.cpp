...
status_t
AttribPolyblob::GetSupportedSuites(BMessage* message)
{
	message->AddString("suites", "suite/x-sum-becasso-Free Shape");
...
BHandler*
AttribPolyblob::ResolveSpecifier(
...
void
AttribPolyblob::MessageReceived(BMessage* msg)
{
	switch (msg->what) {
		case B_GET_PROPERTY:
		{
