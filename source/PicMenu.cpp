...
void
PicMenu::setParent(PicMenuButton* pmb)
{
	parent = pmb;
...
//
void
PicMenu::AddItem(PicItem* item, const BRect rect)
{
...
void
PicMenu::MouseMoved(BPoint point, uint32 transit, const BMessage* msg)
{
	msg = msg;
	uint32 buttons;
	if (!Parent())
...
void
PicMenu::TearDone(BRect place, bool newwin)
{
	if (newwin) {
